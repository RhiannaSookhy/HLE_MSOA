...
#Code to create marmot curve for 2011 HLE data in preparation for latest data
...
#regional marmot curves

library(tidyverse)

#Create a regional plotting function 
